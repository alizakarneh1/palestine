...
var format_Israeli_Sattelments_5 = new ol.format.GeoJSON();
var features_Israeli_Sattelments_5 = format_Israeli_Sattelments_5.readFeatures(json_Israeli_Sattelments_5, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Israeli_Sattelments_5 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Israeli_Sattelments_5.addFeatures(features_Israeli_Sattelments_5);
var lyr_Israeli_Sattelments_5 = new ol.layer.Vector({
                declutter: true,
                source:jsonSource_Israeli_Sattelments_5, 
                style: style_Israeli_Sattelments_5,
                interactive: true,
                title: '<img src="styles/legend/Israeli_Sattelments_5.png" /> Israeli_Sattelments'
            });
...
var lyr_districts_6 = new ol.layer.Vector({
                ...
                interactive: true,
    title: 'districts<br />\
    <img src="styles/legend/districts_6_0.png" /> <br />\
    <img src="styles/legend/districts_6_1.png" /> Bethlehem<br />\
    <img src="styles/legend/districts_6_2.png" /> Hebron<br />\
    <img src="styles/legend/districts_6_3.png" /> Jenin<br />\
    <img src="styles/legend/districts_6_4.png" /> Jericho<br />\
    <img src="styles/legend/districts_6_5.png" /> Jerusalem<br />\
    <img src="styles/legend/districts_6_6.png" /> Nablus<br />\
    <img src="styles/legend/districts_6_7.png" /> Ramallah<br />\
    <img src="styles/legend/districts_6_8.png" /> Tulkarem<br />'
        });

lyr_palestine_0.setVisible(true);lyr_Boarders_Lines_1.setVisible(true);lyr_Natural_Reserves_2.setVisible(true);lyr_maincities_3.setVisible(true);lyr_roads_4.setVisible(true);lyr_Israeli_Sattelments_5.setVisible(true);lyr_districts_6.setVisible(true);
var layersList = [lyr_palestine_0,lyr_Boarders_Lines_1,lyr_Natural_Reserves_2,lyr_maincities_3,lyr_roads_4,lyr_Israeli_Sattelments_5,lyr_districts_6];
...
lyr_roads_4.set('fieldAliases', {'THEID': 'THEID', 'TYPE': 'TYPE', });
lyr_Israeli_Sattelments_5.set('fieldAliases', {'OBJECTID_1': 'OBJECTID_1', 'OBJECTID_2': 'OBJECTID_2', 'OBJECTID': 'OBJECTID', 'type_colon': 'type_colon', 'class2': 'class2', 'Shape_Leng': 'Shape_Leng', 'Shape_Area': 'Shape_Area', });
lyr_districts_6.set('fieldAliases', {'AREA': 'AREA', 'PERIMETER': 'PERIMETER', 'GOVERNORAT': 'GOVERNORAT', 'GOVERNORAT_1': 'GOVERNORAT_1', 'NAME': 'NAME', 'POP2020': 'POP2020', 'POP2010': 'POP2010', 'NEWPCBS_CO': 'NEWPCBS_CO', });
...
lyr_roads_4.set('fieldImages', {'THEID': 'Range', 'TYPE': 'TextEdit', });
lyr_Israeli_Sattelments_5.set('fieldImages', {'OBJECTID_1': 'TextEdit', 'OBJECTID_2': 'TextEdit', 'OBJECTID': 'TextEdit', 'type_colon': 'TextEdit', 'class2': 'TextEdit', 'Shape_Leng': 'TextEdit', 'Shape_Area': 'TextEdit', });
lyr_districts_6.set('fieldImages', {'AREA': 'TextEdit', 'PERIMETER': 'TextEdit', 'GOVERNORAT': 'TextEdit', 'GOVERNORAT_1': 'TextEdit', 'NAME': 'TextEdit', 'POP2020': 'TextEdit', 'POP2010': 'TextEdit', 'NEWPCBS_CO': 'TextEdit', });
...
lyr_roads_4.set('fieldLabels', {'THEID': 'no label', 'TYPE': 'no label', });
lyr_Israeli_Sattelments_5.set('fieldLabels', {'OBJECTID_1': 'no label', 'OBJECTID_2': 'no label', 'OBJECTID': 'no label', 'type_colon': 'no label', 'class2': 'no label', 'Shape_Leng': 'no label', 'Shape_Area': 'no label', });
lyr_districts_6.set('fieldLabels', {'AREA': 'inline label', 'PERIMETER': 'no label', 'GOVERNORAT': 'no label', 'GOVERNORAT_1': 'no label', 'NAME': 'inline label', 'POP2020': 'inline label', 'POP2010': 'no label', 'NEWPCBS_CO': 'no label', });
